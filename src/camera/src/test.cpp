...
// std::list<ns::Blob> findBlobs(rs2::depth_frame depthFrame, float width, float height);
...
//             int loc = x + y * width;
//             float depth_val = depthFrame.get_distance(y,x);
                    
//             float d = distSqDepth(depth_val, trackedDepth); 
